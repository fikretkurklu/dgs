...
<html>
  ...
  <head><title>Shop Steam Keys - DGS</title></head>
  <body>
      ...
      ?>
            ...
            <main id='main'>
                <section id='sectionshop' style='text-align:center;'>
                  <h5 style="font-weight:bold;margin-bottom:60px;">STEAM KEYS</h5>
                    <div class="row">
                        <?php
                                $objectmanager = new ObjectManager($bdd);
                                $result = $objectmanager->getListSteam();
